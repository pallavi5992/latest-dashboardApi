...
router.get("/get-Tn-Single-data-Investment-corridor",controller.getTnSingleDataInvestmentDefence);
router.get("/get-All-tn-Dashboarddata-defence-corridor",controller.getAlldashboardData);
